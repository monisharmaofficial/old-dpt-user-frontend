...
const Header = ({
  ...
  useEffect(() => {
    ...
    setCartData(storedCartData ? JSON.parse(storedCartData) : []);
  }, []);

  // Handle currency change
  const handleCurrencyChange = (currency) => {
    localStorage.removeItem("cartdata");
    setCurrency(currency); // Update the selected currency
  };
  ...
  const googleTranslateElementInit = () => {
    new window.google.translate.TranslateElement(
      {
        pageLanguage: "en",
        includedLanguages: "en,es,pt,nl,it,de,fr,ru,zh", // List of languages you want to support
  ...
  useEffect(() => {
    ...
    loadGoogleTranslateScript(); // Trigger the script loading
            ...
            <div className="HeaderLhs">
              <div className="Logo">
                <Link to="/">
                  <img
                    src={
                      "https://res.cloudinary.com/dqslvlm0d/image/upload/v1701321572/logo_ivx2ol.svg"
                    }
                    alt="logo"
                  />
                </Link>
