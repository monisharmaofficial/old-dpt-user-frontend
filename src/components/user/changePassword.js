          ...
          <div className="userHeaderIn">
            <div className="userHeaderLhs">
              <div className="logo">
                <Link to="/">
                  <img
                    src={
                      "https://res.cloudinary.com/dqslvlm0d/image/upload/v1701321722/innerlogo_yezfc1.svg"
                    }
                    alt=""
                  />
                </Link>
              </div>
              <div className="userboardTitle">
                <span
                  className="ToggleBtn"
            ...
            <div className="userHeaderRhs">
              ...
              <div className="dropdown userIcon">
                <Link
                  className="btn userIconTag dropdown-toggle"
                  to="#"
                  role="button"
                  id="userIcon"
          ...
          >
            <div className="topSidebar">
              ...
              <Link to="/booking" className="nav-link MyBookingIcon">
                <img src="images/homepage/mybookingicon.png" alt="" /> My
                Bookings
              </Link>
              ...
              <Link
                to="/changepassword"
                className="nav-link active ChangePassWordIcon"
              >
                    ...
                    <div className="mb-3">
                      ...
                      {oldPasswordError && (
                        <p className="text-danger">
                          Previous password didn't match.
                        </p>
                      )}
