...
const visaLHS = () => {
  return (
    <>
       <div className="TouristVisaLhs">
                            <div className="TripadvisorImgNewa">
                ...
                >
                  ...
                  >
                            ...
                            <dl>
                              ...
                              <dd>
                                <div className="widSSPOverall">
                                  ...
                                  />
                                  <div>
                                    Based on <b>2560</b> traveler reviews
                                  </div>
                                </div>
                                {/*/ overall */}{" "}
                              </dd>
                    ...
                    {/*/ CDSPOP.cdsBx*/}
                            ...
                            {/*TripadvisorImgNew*/}
                            <div className="adv">
                                <img src={"https://res.cloudinary.com/dqslvlm0d/image/upload/v1702453157/adv1_kmxirb.jpg"} alt="" />
                            </div>
                            <div className="adv">
                                <img src={"https://res.cloudinary.com/dqslvlm0d/image/upload/v1702453156/adv2_eoudli.jpg"} alt="" />
                            </div>
                            <div className="adv">
                                <img src={"https://res.cloudinary.com/dqslvlm0d/image/upload/v1702453157/adv3_zc0tbt.jpg"} alt="" />
                            </div>
                            <div className="adv">
                                <img src={"https://res.cloudinary.com/dqslvlm0d/image/upload/v1702453157/adv4_fonkkd.jpg"} alt="" />
                            </div>
                        </div>
    </>
  )
